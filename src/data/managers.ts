...
export const MANAGERS: Manager[] = [
  ...
  { displayName: 'Tyler', teamName: "I Fielder Boobs", teamSlug: 'i-fielder-boobs', role: 'owner', draftPosition: 5, colorKey: 'Tyler', email: 'tyler.parkhurst@gmail.com', yahooTeamKey: '469.l.24701.t.12', logo: '/logos/i-fielder-boobs.png', theme: { gradient: 'from-purple-800 to-blue-900', tagline: 'Swing for the Fences', textColor: 'text-purple-100' } },
